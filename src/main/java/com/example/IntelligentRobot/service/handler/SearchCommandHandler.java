...
import com.example.IntelligentRobot.service.SearchIndexService;
import com.example.IntelligentRobot.service.SearchSyncScheduler;
...
public class SearchCommandHandler {
    ...
    public SearchCommandHandler(FeishuClient feishuClient, SearchIndexService indexService,
    ...
    @Command(
        name = "search",
        description = "搜索群内文件和知识库",
        usage = "/search <关键词>"
    )
    public String handle(CommandContext context) {
        String keyword = context.getArgs().trim();
