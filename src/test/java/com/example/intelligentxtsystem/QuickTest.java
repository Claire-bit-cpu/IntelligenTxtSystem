...
import com.example.intelligentxtsystem.service.CommandRegistry;
...
public class QuickTest {
    ...
    private CommandContext createContext(String message) {
        ...
        com.example.intelligentxtsystem.dto.FeishuSender sender = new com.example.intelligentxtsystem.dto.FeishuSender();
        sender.setSenderId("test_user");
        // 设置 sender_id 对象的 open_id
        com.example.intelligentxtsystem.dto.FeishuSender.SenderId senderId = new com.example.intelligentxtsystem.dto.FeishuSender.SenderId();
